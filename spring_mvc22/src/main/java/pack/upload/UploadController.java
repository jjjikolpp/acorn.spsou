...
public class UploadController {
   ...
   public ModelAndView fileUploaded(@ModelAttribute("uploadBean") UploadBean uploadBean,BindingResult result){
      ...
      return new ModelAndView("uploaded","filename",fileName);
   }
}
